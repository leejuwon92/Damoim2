...
<fmt:formatDate value="${deadline}" pattern="yyyy-MM-dd" var="dead"/>
<fmt:parseDate value="${post.meetingDate}" var="meetingDate" pattern="yyyy-MM-dd"/>
<fmt:formatDate value="${meetingDate}" pattern="yyyy-MM-dd" var="meeting"/>
...
<div class="container">
	...
	<form method="post" enctype="multipart/form-data" action= "${pageContext.request.contextPath }/front?key=host&mn=hostPostUpdate" id="createForm">
    	...
    	<div class="form-group">
			...
			<input type="text" autocomplete="off" class="form-control" name="deadline" id="deadline" value="${dead}"/>
		</div>
		<br>
		<div class="form-group pmd-textfield pmd-textfield-floating-label">
			<label for="meetingDate">모임일자</label>
			<input type="text" autocomplete="off" class="form-control" name="meetingDate" id="meetingDate" value="${meeting}"/>
	  	</div>
		...
		<div style="text-align: left">
			<input type="submit" id="submit" class="btn btn-outline-primary" value="수정하기">
