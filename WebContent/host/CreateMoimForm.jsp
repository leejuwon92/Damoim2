...
<form method="post" enctype="multipart/form-data" action= "../front?key=host&mn=hostPostInsert" id="createForm" onSubmit='return checkValid()'>
	...
	<br>
	<h3>썸네일 이미지</h3>
	<span>파일첨부:</span><input type="file" class="form-control-file" id="thumbnailFile" name="thumbnailFile">
	<br>
	<h3>배너 이미지</h3>
	<span>파일첨부:</span><input type="file" class="form-control-file" id="bannerFile" name="bannerFile">
	<br>
	<h3>카테고리</h3>
