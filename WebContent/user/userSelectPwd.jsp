...
<body>
	...
	<form id = "selectIdForm" method="post" action="${pageContext.request.contextPath}/front?key=user&mn=userSelectPwd">
		<h1>비밀번호 찾기</h1>
		<br>
			아이디:&nbsp;<input type="text" name="id" id="user_id" size="20"/><br>	
			...
			<p>
			<input type="button" value="비밀번호 찾기" id="selectPwdBtn" />&nbsp;&nbsp;&nbsp; 
